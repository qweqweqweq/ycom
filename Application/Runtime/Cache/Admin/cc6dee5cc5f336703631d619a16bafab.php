...
<!-- 占位符 -->
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>管理员列表</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-bordered table-striped table-condensed">
						  ...
						  <tbody>
							<?php if(is_array($users)): foreach($users as $key=>$data): ?><tr>
									<td class="center"><?php echo ($data['name']); ?></td>
									<td class="center"><?php echo ($data['tel']); ?></td>
									<!-- <td class="center">
										<a class="btn btn-info" href="<?php echo U('User/findUser');?>?id=<?php echo ($data['id']); ?>">
	...
	</div><!--/<div class="fluid-container"></div>-->
